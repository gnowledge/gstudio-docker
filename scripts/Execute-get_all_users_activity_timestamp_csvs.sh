...
if ([ ${day_of_week} == "Friday" -a ${day_of_month} -ge 1 -a ${day_of_month} -le 14 ] || [ ${day_of_week} == "Friday" -a ${day_of_month} -ge 22 -a ${day_of_month} -le 28 ]); then # || [ ${day_of_week} == "Sunday" -a ${day_of_month} -ge 22 -a ${day_of_month} -le 28 ] || []); then
