...
## Download the update tar file:
	...
	updates dt 27-09-2017 (all updates in single tar file):
        https://clixplatform.tiss.edu/softwares/clix-schoolserver-updates/update_patch-ab4e6f6-r2-20170927.tar.gz
		https://clixplatform.tiss.edu/softwares/clix-schoolserver-updates/update_patch-ab4e6f6-r2-20170927.tar.gz.md5sum
...
## Check md5sum for file checksum:
	Command : ``` md5sum update_patch-ab4e6f6-r2-20170927.tar.gz ```
    Ensure that the alphanumeric code (output of the above command) is matching with the content of update_patch-ab4e6f6-r2-20170927.tar.gz.md5sum (which you have downloaded from the server)
...
## Update-patch number: (One commit no back of gstudio-docker)
	...
	Exact Number 	: 	``` update_patch-ab4e6f6-r2-20170927``
...
### gstudio-docker:			(https://github.com/mrunal4/gstudio-docker.git - master)
	Short			:	``` ab4e6f6 ```
	Long			: 	``` ab4e6f64d5c9bd4c1f88e171b90aefb5493b9531 ```
