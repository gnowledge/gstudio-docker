...
## Download the update tar file:
	...
	updates dt 29-09-2017 (all updates in single tar file):
        https://clixplatform.tiss.edu/softwares/clix-schoolserver-updates/update_patch-1597e41-r2-20170929.tar.gz
		https://clixplatform.tiss.edu/softwares/clix-schoolserver-updates/update_patch-1597e41-r2-20170929.tar.gz.md5sum
...
## Check md5sum for file checksum:
	Command : ``` md5sum update_patch-1597e41-r2-20170929.tar.gz ```
    Ensure that the alphanumeric code (output of the above command) is matching with the content of update_patch-1597e41-r2-20170929.tar.gz.md5sum (which you have downloaded from the server)
...
## Update-patch number: (One commit no back of gstudio-docker)
	...
	Exact Number 	: 	``` update_patch-1597e41-r2-20170929 ``
